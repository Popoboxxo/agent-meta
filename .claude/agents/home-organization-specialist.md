...
```
.claude/skills/home-organization/SKILL.md
```

Alle Referenzdokumente liegen unter `.claude/skills/home-organization` und werden dort per Read-Tool bei Bedarf geladen.

Falls du detaillierte Referenzen brauchst, lies mit dem Read-Tool:
- `.claude/skills/home-organization/cross-system-compatibility.md`
- `.claude/skills/home-organization/deskware-reference.md`
- `.claude/skills/home-organization/french-cleat-reference.md`
- `.claude/skills/home-organization/frenchfinity-reference.md`
- `.claude/skills/home-organization/gridfinity-reference.md`
- `.claude/skills/home-organization/neogrid-reference.md`
- `.claude/skills/home-organization/opengrid-reference.md`
- `.claude/skills/home-organization/underware-reference.md`
