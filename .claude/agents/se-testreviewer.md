...
> **Extension:** Falls .claude/3-project/am-se-testreviewer-ext.md existiert → jetzt sofort lesen und vollständig anwenden.
...
`python scripts/viz-logger.py --agent se-testreviewer --provider Claude --event <EVENT_TYPE> [weitere Parameter...]`
