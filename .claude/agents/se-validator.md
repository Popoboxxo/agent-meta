...
> **Extension:** Falls `.claude/3-project/am-se-validator-ext.md` existiert → jetzt sofort lesen und vollständig anwenden.
...
`python scripts/viz-logger.py --agent se-validator --provider Claude --event <EVENT_TYPE> [weitere Parameter...]`
