...
> **Extension:** If `.claude/3-project/am-technical-writer-ext.md` exists → read and apply immediately.
...
2. **Read context:** `.claude/3-project/am-technical-writer-ext.md` if present.
