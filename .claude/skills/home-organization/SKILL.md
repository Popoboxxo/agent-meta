...
- **.claude/skills/home-organization/gridfinity-reference.md** - Small item desktop/drawer organization (42mm grid)
- **.claude/skills/home-organization/opengrid-reference.md** - Wall-mounted framework (28mm grid)
- **.claude/skills/home-organization/neogrid-reference.md** - Large item drawer dividers (hybrid 3D-printed connectors)
- **.claude/skills/home-organization/french-cleat-reference.md** - Heavy-duty wall mounting (45° angled cleats)
- **.claude/skills/home-organization/underware-reference.md** - Cable management channels (OpenGrid-compatible)
- **.claude/skills/home-organization/deskware-reference.md** - Modular desk risers with Gridfinity/OpenGrid integration
- **.claude/skills/home-organization/cross-system-compatibility.md** - Interoperability matrix between systems
- **.claude/skills/home-organization/frenchfinity-reference.md** - Modular French Cleat tool holders with Gridfinity integration
...
Read .claude/skills/home-organization/cross-system-compatibility.md for detailed compatibility notes.
