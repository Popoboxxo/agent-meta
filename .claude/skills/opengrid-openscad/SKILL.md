...
- **MultiConnect Mounting**: Slotted backplate system using `multiconnectBack()` module (see .claude/skills/opengrid-openscad/common_items/backplate_mount.md)

**Pattern references** (read as needed):

- .claude/skills/opengrid-openscad/common_items/\*.md - Full OpenSCAD modules for each pattern
- .claude/skills/opengrid-openscad/enhancements.md - Optional feature modules
...
// DO read .claude/skills/opengrid-openscad/common_items/basic_bin.md and use/adapt the module
...
- **Enhance**: User wants label recess, drainage, etc. (use .claude/skills/opengrid-openscad/enhancements.md)
...
**Available enhancements** (see .claude/skills/opengrid-openscad/enhancements.md for modules):
...
.claude/skills/opengrid-openscad/enhancements.md                 - Optional features (labels, drainage, etc.)
```
