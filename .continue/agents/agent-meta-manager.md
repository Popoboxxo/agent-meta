...
alwaysApply: false
---
> **Extension:** If `.continue/3-project/am-agent-meta-manager-ext.md` exists → read and apply immediately.
...
| Completely different workflow | `.continue/3-project/<role>.md` (manual) |
