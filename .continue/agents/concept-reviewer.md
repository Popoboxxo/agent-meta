...
alwaysApply: false
---
> **Extension:** If `.continue/3-project/am-concept-reviewer-ext.md` exists → read and apply immediately.
...
Full: `.continue/snippets/concept-review-report.md` (sync-generated). Sections: Scope · Findings by severity · Verdict + rationale.
</workflow>
