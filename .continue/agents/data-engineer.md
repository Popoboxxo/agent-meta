...
alwaysApply: false
---
> **Extension:** If `.continue/3-project/am-data-engineer-ext.md` exists → read and apply immediately.
...
2. **REQ check:** 
3. **Read context:** `.continue/3-project/am-data-engineer-ext.md` if present. `.continue/snippets/` if present — apply patterns.
