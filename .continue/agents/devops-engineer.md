...
> **Extension:** Falls `.continue/3-project/am-devops-engineer-ext.md` existiert → jetzt sofort lesen und vollständig anwenden.
...
`python scripts/viz-logger.py --agent devops-engineer --provider Continue --event <EVENT_TYPE> [weitere Parameter...]`
