...
alwaysApply: false
---
> **Extension:** If `.continue/3-project/am-feedback-ext.md` exists → read and apply immediately.
...
Own template per type (description/steps/expected/actual/environment). Full templates: `.continue/snippets/feedback-templates.md` (sync-generated).
