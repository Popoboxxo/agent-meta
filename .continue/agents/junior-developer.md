...
alwaysApply: false
---
> **Extension:** If `.continue/3-project/am-junior-developer-ext.md` exists → read and apply immediately.
...
**Language best practices:** Strictly follow the best practices of `Python 3, Markdown, YAML`. If `.continue/snippets/` exists: read now, apply all patterns.
</context>
