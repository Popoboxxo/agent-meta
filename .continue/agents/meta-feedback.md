...
alwaysApply: false
---
> **Extension:** If `.continue/3-project/am-meta-feedback-ext.md` exists → read and apply immediately.
...
Full body templates: `.continue/snippets/meta-feedback-templates.md`.
</workflow>
