...
```
.continue/skills/reqogniloom-quality-auditor/quality-auditor.md
```

Alle Referenzdokumente liegen unter `.continue/skills/reqogniloom-quality-auditor` und werden dort per Read-Tool bei Bedarf geladen.
