...
alwaysApply: false
---
> **Extension:** If `.continue/3-project/am-refactoring-specialist-ext.md` exists → read and apply immediately.
...
2. **REQ check:** 
3. **Read context:** `.continue/3-project/am-refactoring-specialist-ext.md` if present. `.continue/snippets/` if present — apply patterns.
...
Strictly follow the best practices of `Python 3, Markdown, YAML`. If `.continue/snippets/` exists: read immediately, apply all patterns.
</context>
