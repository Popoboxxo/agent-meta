...
alwaysApply: false
---
> **Extension:** If `.continue/3-project/am-ui-ux-designer-ext.md` exists → read and apply immediately.
...
ASCII wireframe skeleton: `.continue/snippets/wireframe-template.md`.
...
Full schema: `.continue/snippets/design-system-skeleton.yaml`.
