...
- **.continue/skills/home-organization/gridfinity-reference.md** - Small item desktop/drawer organization (42mm grid)
- **.continue/skills/home-organization/opengrid-reference.md** - Wall-mounted framework (28mm grid)
- **.continue/skills/home-organization/neogrid-reference.md** - Large item drawer dividers (hybrid 3D-printed connectors)
- **.continue/skills/home-organization/french-cleat-reference.md** - Heavy-duty wall mounting (45° angled cleats)
- **.continue/skills/home-organization/underware-reference.md** - Cable management channels (OpenGrid-compatible)
- **.continue/skills/home-organization/deskware-reference.md** - Modular desk risers with Gridfinity/OpenGrid integration
- **.continue/skills/home-organization/cross-system-compatibility.md** - Interoperability matrix between systems
- **.continue/skills/home-organization/frenchfinity-reference.md** - Modular French Cleat tool holders with Gridfinity integration
...
Read .continue/skills/home-organization/cross-system-compatibility.md for detailed compatibility notes.
