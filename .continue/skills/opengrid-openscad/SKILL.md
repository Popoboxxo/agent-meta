...
- **MultiConnect Mounting**: Slotted backplate system using `multiconnectBack()` module (see .continue/skills/opengrid-openscad/common_items/backplate_mount.md)

**Pattern references** (read as needed):

- .continue/skills/opengrid-openscad/common_items/\*.md - Full OpenSCAD modules for each pattern
- .continue/skills/opengrid-openscad/enhancements.md - Optional feature modules
...
// DO read .continue/skills/opengrid-openscad/common_items/basic_bin.md and use/adapt the module
...
- **Enhance**: User wants label recess, drainage, etc. (use .continue/skills/opengrid-openscad/enhancements.md)
...
**Available enhancements** (see .continue/skills/opengrid-openscad/enhancements.md for modules):
...
.continue/skills/opengrid-openscad/enhancements.md                 - Optional features (labels, drainage, etc.)
```
