...
> **Extension:** If `.gemini/3-project/am-api-specialist-ext.md` exists → read and apply immediately.
...
Full: `.gemini/snippets/openapi-skeleton.yaml`. Required top-level: `openapi`, `info`, `servers[]`, `paths`, `components.schemas`, `components.responses`.
