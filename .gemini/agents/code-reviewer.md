...
> **Extension:** Falls `.gemini/3-project/am-code-reviewer-ext.md` existiert → jetzt sofort lesen und vollständig anwenden.
...
`python scripts/viz-logger.py --agent code-reviewer --provider Gemini --event <EVENT_TYPE> [weitere Parameter...]`
