...
> **Extension:** If `.gemini/3-project/am-concept-reviewer-ext.md` exists → read and apply immediately.
...
Read the format template from `.gemini/snippets/concept-review-report.md` (sync-generated).
