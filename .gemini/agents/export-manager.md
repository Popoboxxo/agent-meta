...
> **Extension:** If `.gemini/3-project/am-export-manager-ext.md` exists → read and apply immediately.
...
Example YAML: `.gemini/snippets/export-config.example.yaml`.
...
Full: `.gemini/snippets/export-transformations.md`.
