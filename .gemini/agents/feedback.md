...
> **Extension:** If `.gemini/3-project/am-feedback-ext.md` exists → read and apply immediately.
...
Own template per type (description/steps/expected/actual/environment). Full templates: `.gemini/snippets/feedback-templates.md` (sync-generated).
