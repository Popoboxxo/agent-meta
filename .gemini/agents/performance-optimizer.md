...
> **Extension:** Falls `.gemini/3-project/am-performance-optimizer-ext.md` existiert → jetzt sofort lesen und vollständig anwenden.
...
`python scripts/viz-logger.py --agent performance-optimizer --provider Gemini --event <EVENT_TYPE> [weitere Parameter...]`
