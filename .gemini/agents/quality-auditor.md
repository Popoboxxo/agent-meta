...
```
.gemini/skills/reqogniloom-quality-auditor/quality-auditor.md
```

Alle Referenzdokumente liegen unter `.gemini/skills/reqogniloom-quality-auditor` und werden dort per Read-Tool bei Bedarf geladen.
