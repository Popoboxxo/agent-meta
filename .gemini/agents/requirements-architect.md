...
```
.gemini/skills/reqogniloom-requirements-architect/requirements-architect.md
```

Alle Referenzdokumente liegen unter `.gemini/skills/reqogniloom-requirements-architect` und werden dort per Read-Tool bei Bedarf geladen.
