...
```
.gemini/skills/reqogniloom-risk-analyst/risk-analyst.md
```

Alle Referenzdokumente liegen unter `.gemini/skills/reqogniloom-risk-analyst` und werden dort per Read-Tool bei Bedarf geladen.
