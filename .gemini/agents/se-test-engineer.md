...
> **Extension:** Falls .gemini/3-project/am-se-test-engineer-ext.md existiert → jetzt sofort lesen und vollständig anwenden.
...
`python scripts/viz-logger.py --agent se-test-engineer --provider Gemini --event <EVENT_TYPE> [weitere Parameter...]`
