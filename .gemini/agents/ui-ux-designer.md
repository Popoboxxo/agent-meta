...
> **Extension:** Falls `.gemini/3-project/am-ui-ux-designer-ext.md` existiert → jetzt sofort lesen und vollständig anwenden.
...
`python scripts/viz-logger.py --agent ui-ux-designer --provider Gemini --event <EVENT_TYPE> [weitere Parameter...]`
