...
2. **Tool-Pflicht:** Nutze die für deinen Provider verfügbare Methodik (- **In Gemini (VS Code):** Nutzt `@orchestrator <Eure Aufgabe>` im Chat.), um den Orchestrator lautlos zu starten und ihm den Auftrag (inkl. deiner Kontext-Erkenntnisse) zu übergeben.
