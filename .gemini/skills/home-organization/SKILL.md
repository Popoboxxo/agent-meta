...
- **.gemini/skills/home-organization/gridfinity-reference.md** - Small item desktop/drawer organization (42mm grid)
- **.gemini/skills/home-organization/opengrid-reference.md** - Wall-mounted framework (28mm grid)
- **.gemini/skills/home-organization/neogrid-reference.md** - Large item drawer dividers (hybrid 3D-printed connectors)
- **.gemini/skills/home-organization/french-cleat-reference.md** - Heavy-duty wall mounting (45° angled cleats)
- **.gemini/skills/home-organization/underware-reference.md** - Cable management channels (OpenGrid-compatible)
- **.gemini/skills/home-organization/deskware-reference.md** - Modular desk risers with Gridfinity/OpenGrid integration
- **.gemini/skills/home-organization/cross-system-compatibility.md** - Interoperability matrix between systems
- **.gemini/skills/home-organization/frenchfinity-reference.md** - Modular French Cleat tool holders with Gridfinity integration
...
Read .gemini/skills/home-organization/cross-system-compatibility.md for detailed compatibility notes.
