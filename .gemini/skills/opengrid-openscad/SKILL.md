...
- **MultiConnect Mounting**: Slotted backplate system using `multiconnectBack()` module (see .gemini/skills/opengrid-openscad/common_items/backplate_mount.md)

**Pattern references** (read as needed):

- .gemini/skills/opengrid-openscad/common_items/\*.md - Full OpenSCAD modules for each pattern
- .gemini/skills/opengrid-openscad/enhancements.md - Optional feature modules
...
// DO read .gemini/skills/opengrid-openscad/common_items/basic_bin.md and use/adapt the module
...
- **Enhance**: User wants label recess, drainage, etc. (use .gemini/skills/opengrid-openscad/enhancements.md)
...
**Available enhancements** (see .gemini/skills/opengrid-openscad/enhancements.md for modules):
...
.gemini/skills/opengrid-openscad/enhancements.md                 - Optional features (labels, drainage, etc.)
```
