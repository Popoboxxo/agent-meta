...
---
> **Extension:** If `.github/copilot/3-project/am-accessibility-specialist-ext.md` exists → read and apply immediately.
...
2. **Read context:** `.github/copilot/3-project/am-accessibility-specialist-ext.md` if present.
