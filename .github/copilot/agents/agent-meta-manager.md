...
---
> **Extension:** If `.github/copilot/3-project/am-agent-meta-manager-ext.md` exists → read and apply immediately.
...
| Completely different workflow | `.github/copilot/3-project/<role>.md` (manual) |
...
**Version info:** v0.90.10 (2026-07-30)
</context>
