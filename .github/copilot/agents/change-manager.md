...
```
.github/copilot/skills/reqogniloom-change-manager/change-manager.md
```

Alle Referenzdokumente liegen unter `.github/copilot/skills/reqogniloom-change-manager` und werden dort per Read-Tool bei Bedarf geladen.
