...
> **Extension:** Falls `.github/copilot/3-project/am-code-reviewer-ext.md` existiert → jetzt sofort lesen und vollständig anwenden.
...
`python scripts/viz-logger.py --agent code-reviewer --provider Copilot --event <EVENT_TYPE> [weitere Parameter...]`
