...
---
> **Extension:** If `.github/copilot/3-project/am-data-engineer-ext.md` exists → read and apply immediately.
...
2. **REQ check:** 
3. **Read context:** `.github/copilot/3-project/am-data-engineer-ext.md` if present. `.github/copilot/snippets/` if present — apply patterns.
