...
> **Extension:** Falls `.github/copilot/3-project/am-developer-ext.md` existiert → jetzt sofort lesen und vollständig anwenden.
...
`python scripts/viz-logger.py --agent developer --provider Copilot --event <EVENT_TYPE> [weitere Parameter...]`
