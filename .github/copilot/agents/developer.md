...
---
> **Extension:** If `.github/copilot/3-project/am-developer-ext.md` exists → read and apply immediately.
...
4. **Read context:** `.github/copilot/3-project/am-developer-ext.md` if present. `.github/copilot/snippets/` if present — apply all code patterns.
