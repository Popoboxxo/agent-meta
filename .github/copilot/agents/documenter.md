...
> **Extension:** Falls `.github/copilot/3-project/am-documenter-ext.md` existiert → jetzt sofort lesen und vollständig anwenden.
...
`python scripts/viz-logger.py --agent documenter --provider Copilot --event <EVENT_TYPE> [weitere Parameter...]`
