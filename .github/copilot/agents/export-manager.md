...
---
> **Extension:** If `.github/copilot/3-project/am-export-manager-ext.md` exists → read and apply immediately.
...
Example YAML: `.github/copilot/snippets/export-config.example.yaml`.
...
Full: `.github/copilot/snippets/export-transformations.md`.
