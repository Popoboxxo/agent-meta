...
---
> **Extension:** If `.github/copilot/3-project/am-feature-ext.md` exists → read and apply immediately.
...
Full prompts: `.github/copilot/snippets/feature-lifecycle.md` (sync-generated).
