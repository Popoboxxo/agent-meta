...
> **Extension:** Falls `.github/copilot/3-project/am-meta-feedback-ext.md` existiert → jetzt sofort lesen und vollständig anwenden.
...
`python scripts/viz-logger.py --agent meta-feedback --provider Copilot --event <EVENT_TYPE> [weitere Parameter...]`
