...
```
.github/copilot/skills/opengrid-openscad/SKILL.md
```

Alle Referenzdokumente liegen unter `.github/copilot/skills/opengrid-openscad` und werden dort per Read-Tool bei Bedarf geladen.

Falls du detaillierte Referenzen brauchst, lies mit dem Read-Tool:
- `.github/copilot/skills/opengrid-openscad/enhancements.md`
