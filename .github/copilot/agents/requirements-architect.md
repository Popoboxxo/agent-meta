...
> **Spezialisierung:** ReqogniLoom Requirements Architect Agent
>
...
```
.github/copilot/skills/reqogniloom-requirements-architect/requirements-architect.md
```

Alle Referenzdokumente liegen unter `.github/copilot/skills/reqogniloom-requirements-architect` und werden dort per Read-Tool bei Bedarf geladen.

_Keine weiteren Referenzdateien konfiguriert._
