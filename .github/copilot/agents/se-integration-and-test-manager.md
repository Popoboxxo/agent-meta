...
> **Extension:** Falls `.github/copilot/3-project/am-se-integration-and-test-manager-ext.md` existiert → jetzt sofort lesen und vollständig anwenden.
...
`python scripts/viz-logger.py --agent se-integration-and-test-manager --provider Copilot --event <EVENT_TYPE> [weitere Parameter...]`
