...
---
> **Extension:** If `.github/copilot/3-project/am-ui-ux-designer-ext.md` exists → read and apply immediately.
...
ASCII wireframe skeleton: `.github/copilot/snippets/wireframe-template.md`.
...
Full schema: `.github/copilot/snippets/design-system-skeleton.yaml`.
