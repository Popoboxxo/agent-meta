...
Beim Start einer neuen Konversation: prüfe ob `.github/copilot/pending-tasks.md` existiert.

## Pflicht beim Konversations-Start

```bash
# Prüfen ob Lifecycle-Tasks ausstehen
test -f .github/copilot/pending-tasks.md && cat .github/copilot/pending-tasks.md
```
...
4. Nach Erledigung aller Tasks: lösche `.github/copilot/pending-tasks.md`.
...
Datei nicht committen — sie ist gitignored (`.github/copilot/pending-tasks.md`).
