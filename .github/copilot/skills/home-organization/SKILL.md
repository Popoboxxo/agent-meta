...
- **.github/copilot/skills/home-organization/gridfinity-reference.md** - Small item desktop/drawer organization (42mm grid)
- **.github/copilot/skills/home-organization/opengrid-reference.md** - Wall-mounted framework (28mm grid)
- **.github/copilot/skills/home-organization/neogrid-reference.md** - Large item drawer dividers (hybrid 3D-printed connectors)
- **.github/copilot/skills/home-organization/french-cleat-reference.md** - Heavy-duty wall mounting (45° angled cleats)
- **.github/copilot/skills/home-organization/underware-reference.md** - Cable management channels (OpenGrid-compatible)
- **.github/copilot/skills/home-organization/deskware-reference.md** - Modular desk risers with Gridfinity/OpenGrid integration
- **.github/copilot/skills/home-organization/cross-system-compatibility.md** - Interoperability matrix between systems
- **.github/copilot/skills/home-organization/frenchfinity-reference.md** - Modular French Cleat tool holders with Gridfinity integration
...
Read .github/copilot/skills/home-organization/cross-system-compatibility.md for detailed compatibility notes.
