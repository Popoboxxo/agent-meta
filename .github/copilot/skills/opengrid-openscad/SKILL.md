...
- **MultiConnect Mounting**: Slotted backplate system using `multiconnectBack()` module (see .github/copilot/skills/opengrid-openscad/common_items/backplate_mount.md)

**Pattern references** (read as needed):

- .github/copilot/skills/opengrid-openscad/common_items/\*.md - Full OpenSCAD modules for each pattern
- .github/copilot/skills/opengrid-openscad/enhancements.md - Optional feature modules
...
// DO read .github/copilot/skills/opengrid-openscad/common_items/basic_bin.md and use/adapt the module
...
- **Enhance**: User wants label recess, drainage, etc. (use .github/copilot/skills/opengrid-openscad/enhancements.md)
...
**Available enhancements** (see .github/copilot/skills/opengrid-openscad/enhancements.md for modules):
...
.github/copilot/skills/opengrid-openscad/enhancements.md                 - Optional features (labels, drainage, etc.)
```
