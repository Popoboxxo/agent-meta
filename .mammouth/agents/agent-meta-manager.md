...
| Completely different workflow | `.mammouth/3-project/<role>.md` (manual) |
...
# Add
py scripts/sync.py --add-skill <url> --skill-name <n> --source <path> --role <r> --entry <file>
...
**Version info:** v0.101.0-beta.3 (2026-08-28)
</context>
