...
Full pipeline template: `.mammouth/snippets/pipeline-template.yaml`.
...
Full deployment manifest template: `.mammouth/snippets/k8s-deployment.yaml`. Example values: `replicas: 3`, `runAsNonRoot: true`, resource requests, probes `/health/ready` + `/health/live`.
