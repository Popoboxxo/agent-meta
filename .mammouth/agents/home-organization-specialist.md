...
```
.mammouth/skills/home-organization/SKILL.md
```

Alle Referenzdokumente liegen unter `.mammouth/skills/home-organization` und werden dort per Read-Tool bei Bedarf geladen.

Falls du detaillierte Referenzen brauchst, lies mit dem Read-Tool:
- `.mammouth/skills/home-organization/cross-system-compatibility.md`
- `.mammouth/skills/home-organization/deskware-reference.md`
- `.mammouth/skills/home-organization/french-cleat-reference.md`
- `.mammouth/skills/home-organization/frenchfinity-reference.md`
- `.mammouth/skills/home-organization/gridfinity-reference.md`
- `.mammouth/skills/home-organization/neogrid-reference.md`
- `.mammouth/skills/home-organization/opengrid-reference.md`
- `.mammouth/skills/home-organization/underware-reference.md`
