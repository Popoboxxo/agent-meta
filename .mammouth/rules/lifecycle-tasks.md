...
Beim Start einer neuen Konversation: prüfe ob `.mammouth/pending-tasks.md` existiert.

## Pflicht beim Konversations-Start

```bash
# Prüfen ob Lifecycle-Tasks ausstehen
test -f .mammouth/pending-tasks.md && cat .mammouth/pending-tasks.md
```
...
4. Nach Erledigung aller Tasks: lösche `.mammouth/pending-tasks.md`.
...
Datei nicht committen — sie ist gitignored (`.mammouth/pending-tasks.md`).
