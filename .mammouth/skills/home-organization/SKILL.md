...
- **.mammouth/skills/home-organization/gridfinity-reference.md** - Small item desktop/drawer organization (42mm grid)
- **.mammouth/skills/home-organization/opengrid-reference.md** - Wall-mounted framework (28mm grid)
- **.mammouth/skills/home-organization/neogrid-reference.md** - Large item drawer dividers (hybrid 3D-printed connectors)
- **.mammouth/skills/home-organization/french-cleat-reference.md** - Heavy-duty wall mounting (45° angled cleats)
- **.mammouth/skills/home-organization/underware-reference.md** - Cable management channels (OpenGrid-compatible)
- **.mammouth/skills/home-organization/deskware-reference.md** - Modular desk risers with Gridfinity/OpenGrid integration
- **.mammouth/skills/home-organization/cross-system-compatibility.md** - Interoperability matrix between systems
- **.mammouth/skills/home-organization/frenchfinity-reference.md** - Modular French Cleat tool holders with Gridfinity integration
...
Read .mammouth/skills/home-organization/cross-system-compatibility.md for detailed compatibility notes.
