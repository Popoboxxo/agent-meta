...
- **MultiConnect Mounting**: Slotted backplate system using `multiconnectBack()` module (see .mammouth/skills/opengrid-openscad/common_items/backplate_mount.md)

**Pattern references** (read as needed):

- .mammouth/skills/opengrid-openscad/common_items/\*.md - Full OpenSCAD modules for each pattern
- .mammouth/skills/opengrid-openscad/enhancements.md - Optional feature modules
...
// DO read .mammouth/skills/opengrid-openscad/common_items/basic_bin.md and use/adapt the module
...
- **Enhance**: User wants label recess, drainage, etc. (use .mammouth/skills/opengrid-openscad/enhancements.md)
...
**Available enhancements** (see .mammouth/skills/opengrid-openscad/enhancements.md for modules):
...
.mammouth/skills/opengrid-openscad/enhancements.md                 - Optional features (labels, drainage, etc.)
```
