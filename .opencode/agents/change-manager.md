...
```
.opencode/skills/reqogniloom-change-manager/change-manager.md
```

Alle Referenzdokumente liegen unter `.opencode/skills/reqogniloom-change-manager` und werden dort per Read-Tool bei Bedarf geladen.
