...
> **Extension:** Falls `.opencode/3-project/am-docker-ext.md` existiert → jetzt sofort lesen und vollständig anwenden.
...
`python scripts/viz-logger.py --agent docker --provider Opencode --event <EVENT_TYPE> [weitere Parameter...]`
