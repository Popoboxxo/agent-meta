...
```
.opencode/skills/home-organization/SKILL.md
```

Alle Referenzdokumente liegen unter `.opencode/skills/home-organization` und werden dort per Read-Tool bei Bedarf geladen.

Falls du detaillierte Referenzen brauchst, lies mit dem Read-Tool:
- `.opencode/skills/home-organization/cross-system-compatibility.md`
- `.opencode/skills/home-organization/deskware-reference.md`
- `.opencode/skills/home-organization/french-cleat-reference.md`
- `.opencode/skills/home-organization/frenchfinity-reference.md`
- `.opencode/skills/home-organization/gridfinity-reference.md`
- `.opencode/skills/home-organization/neogrid-reference.md`
- `.opencode/skills/home-organization/opengrid-reference.md`
- `.opencode/skills/home-organization/underware-reference.md`
