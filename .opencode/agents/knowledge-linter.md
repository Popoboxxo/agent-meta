...
generated-from: 1-generic/knowledge-linter.md@1.1.0
mode: subagent
permission:
  read: allow
  glob: allow
...
> **Extension:** Falls `.opencode/3-project/am-knowledge-linter-ext.md` existiert → jetzt sofort lesen und vollständig anwenden.
