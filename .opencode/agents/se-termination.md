...
> **Extension:** If `.opencode/3-project/am-se-termination-ext.md` exists → read and apply it immediately.
...
`python scripts/viz-logger.py --agent se-termination --provider Opencode --event <EVENT_TYPE> [weitere Parameter...]`
