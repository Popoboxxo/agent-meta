...
> **Extension:** Falls .opencode/3-project/am-se-testreviewer-ext.md existiert → jetzt sofort lesen und vollständig anwenden.
...
`python scripts/viz-logger.py --agent se-testreviewer --provider Opencode --event <EVENT_TYPE> [weitere Parameter...]`
