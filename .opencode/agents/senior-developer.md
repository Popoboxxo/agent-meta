...
Falls `.opencode/snippets/` existiert: Lies sie jetzt sofort mit dem Read-Tool und wende alle Code-Patterns an.
...
`python scripts/viz-logger.py --agent senior-developer --provider Opencode --event <EVENT_TYPE> [weitere Parameter...]`
