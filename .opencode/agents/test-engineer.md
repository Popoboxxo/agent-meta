...
```
.opencode/skills/reqogniloom-test-engineer/test-engineer.md
```

Alle Referenzdokumente liegen unter `.opencode/skills/reqogniloom-test-engineer` und werden dort per Read-Tool bei Bedarf geladen.
