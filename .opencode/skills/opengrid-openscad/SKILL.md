...
- **MultiConnect Mounting**: Slotted backplate system using `multiconnectBack()` module (see .opencode/skills/opengrid-openscad/common_items/backplate_mount.md)

**Pattern references** (read as needed):

- .opencode/skills/opengrid-openscad/common_items/\*.md - Full OpenSCAD modules for each pattern
- .opencode/skills/opengrid-openscad/enhancements.md - Optional feature modules
...
// DO read .opencode/skills/opengrid-openscad/common_items/basic_bin.md and use/adapt the module
...
- **Enhance**: User wants label recess, drainage, etc. (use .opencode/skills/opengrid-openscad/enhancements.md)
...
**Available enhancements** (see .opencode/skills/opengrid-openscad/enhancements.md for modules):
...
.opencode/skills/opengrid-openscad/enhancements.md                 - Optional features (labels, drainage, etc.)
```
