---
name: tool-graphify
description: "Use when asking architecture or file-relationship questions with graphify — hooks and permitted injections."
---
...
- `.opencode/skills/graphify` (skill) — Claude-Code-Skill (SKILL.md + references), vom graphify-Installer selbst verwaltet
