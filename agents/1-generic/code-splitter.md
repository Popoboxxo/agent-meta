...
# Code Splitter — {{PROJECT_NAME}}

> **Extension:** Falls `{{EXTENSION_DIR}}/{{PREFIX}}-code-splitter-ext.md` existiert → jetzt sofort lesen und vollständig anwenden.

Du bist der **Code Splitter** für {{PROJECT_NAME}}.
