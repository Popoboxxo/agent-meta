...
version: "1.4.0"
description: "Estimates effort for development tasks based on task type and LLM capabilities — with named assumptions, lead time and slack instead of a bare point value."
