...
>
> **Zusätzlich am 2026-09-26 durch den Nutzer entschieden:** **OQ6** und **OQ8** (§11.2).
> Beide Fragen sind damit **geschlossen** und nicht mehr als offene Frage zu führen; §16
> (Selbstreview Rev. 0.3) nennt sie noch als offen — das ist der historische Rev.-0.3-Stand
...
|---|---|---|---|---|---|---|
| W0 | — | Design-Freeze, Contract-Liste, **ein Branch pro Welle** (`chore/docs-consolidation-w<N>`), `.gitignore`-Entscheidung aus OQ6 | — | — | — | — |
...
| **OQ2** | `llms.txt` — generiert oder handgepflegt? | `llms.txt` ist bewusst prosaisch für LLM-Konsum (`llms.txt:3-12`); Vollgenerierung verlöre den Ton. | **Hybrid wie T-2 A**: nur `{{DOCS_PROVIDERS_BLOCK}}` + `{{DOCS_REPO_FACTS_BLOCK}}`, Rest Handtext. | `agent-meta-manager` | Entscheidung vor W1-Abschluss; IC-22 `docs-consolidation.sources` trägt sie | W1 |
...
**Nachtrag 2026-09-26 (Statuswechsel, kein Inhaltswechsel):** **OQ6** und **OQ8** sind durch
**Nutzer-Entscheidung** vom 2026-09-26 **geschlossen** und stehen jetzt in §11.2. Die
verbleibenden offenen Fragen dieser Spec sind damit **OQ1, OQ2, OQ3, OQ4, OQ9** — jede mit
Owner, Empfehlung, Entscheidungsweg und Wellen-Blockade. §16 (Selbstreview Rev. 0.3) und die
Wellenübersicht §9.2 nennen OQ6/OQ8 noch als offen; das ist der **historische Rev.-0.3-Stand**
und bleibt als solcher stehen — maßgeblich für den aktuellen Status ist §11.
...
| Brücke zu offenen Entscheidungen **und** geschlossenen Punkten | §11.1 (OQ1, OQ2, OQ3, OQ4, OQ6, OQ8, OQ9) / §11.2 (OQ5, OQ7 geschlossen) | vorhanden |
