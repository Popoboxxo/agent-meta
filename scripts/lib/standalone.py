...
_CONDITIONAL_FALSE_FLAGS: dict[str, str] = {
    ...
    # route_intent is a harness-registered callable tool with no standalone
    # counterpart — keep the §3 routing-rules fallback (issue #264).
    "ROUTE_INTENT_CALLABLE": "false",
