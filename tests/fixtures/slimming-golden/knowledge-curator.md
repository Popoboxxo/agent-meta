...
- Agent
- TodoWrite
generated-from: 1-generic/knowledge-curator.md@1.4.0
...
> **Extension:** Falls `.claude/3-project/am-knowledge-curator-ext.md` existiert → jetzt sofort lesen und vollständig anwenden.
...
- **Controlled vocabulary (ontology):** only `type:` values defined in `knowledge/schema.md` are valid; propose a new concept type before use, never invent one ad-hoc.
