...
- Write
- Edit
generated-from: 1-generic/knowledge-indexer.md@1.4.0
model: claude-haiku-4-5-20251001
---

# Knowledge Indexer — agent-meta

> **Extension:** Falls `.claude/3-project/am-knowledge-indexer-ext.md` existiert → jetzt sofort lesen und vollständig anwenden.
