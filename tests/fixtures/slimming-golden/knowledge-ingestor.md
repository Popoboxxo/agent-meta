...
- Glob
- Grep
generated-from: 1-generic/knowledge-ingestor.md@1.6.0
model: claude-sonnet-5
---

# Knowledge Ingestor — agent-meta

> **Extension:** Falls `.claude/3-project/am-knowledge-ingestor-ext.md` existiert → jetzt sofort lesen und vollständig anwenden.
...
für Specs und Pläne. Du aktualisierst `knowledge/wiki/index.md` (Auto-Index) bzw.
`knowledge/wiki/log.md` (Auto-Log) nicht selbst, sondern **delegierst intern an
