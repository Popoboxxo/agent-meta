...
- Grep
- Bash
generated-from: 1-generic/knowledge-migrator.md@1.5.0
model: claude-sonnet-5
---

# Knowledge Migrator — agent-meta

> **Extension:** Falls `.claude/3-project/am-knowledge-migrator-ext.md` existiert → jetzt sofort lesen und vollständig anwenden.
...
- **OKF conformance:** migrated pages must use `type:` + frontmatter per `knowledge/schema.md` and the OKF convention; normalize non-conformant legacy content during migration. Frictionless Data is **optional interop only** — never a bundle standard here.
