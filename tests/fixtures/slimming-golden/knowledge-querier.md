...
- Glob
- Grep
generated-from: 1-generic/knowledge-querier.md@1.5.0
model: claude-haiku-4-5-20251001
---

# Knowledge Querier — agent-meta

> **Extension:** Falls `.claude/3-project/am-knowledge-querier-ext.md` existiert → jetzt sofort lesen und vollständig anwenden.
