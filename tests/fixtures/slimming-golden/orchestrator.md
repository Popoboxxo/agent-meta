...
2. background(agent="ideation", prompt="Klassifikation Spike/Bounded/Architectural inkl. S/M/L/XL-Mapping (F7-Zusatzkriterium)") → warten bis abgeschlossen
3. background(agent="concept-specifier", prompt="Technische Spezifikation schreiben (Interface-Contracts, Datenfluss, Akzeptanzkriterien) — XL-Tasks: vorab Systemdesign über concept-architect") → warten bis abgeschlossen
...
⏸ Abnahme erforderlich vor Stage 'approve' — warte auf explizite Nutzerbestätigung, bevor concept-reviewer startet.
4. background(agent="concept-reviewer", prompt="Abnahme der Spec (Status: APPROVED) — explizite Nutzerfreigabe") → warten bis abgeschlossen
5. background(agent="planner", prompt="Umsetzungsplan gegen die freigegebene Spec (Plan-Template, pipeline_stages, F6-Graph-Validator)") → warten bis abgeschlossen
6. background(agent="developer", prompt="Implementierung gegen die freigegebene Spezifikation — Tier nach Task-Größe (S/M/L/XL): S junior-developer, M developer, L senior-developer, XL principal-developer") → warten bis abgeschlossen
    ...
    "name_index": [
      {
        ...
        "tier": "optional",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
      },
      {
        "agent": "agent-meta-manager",
        "short_desc": "agent-meta verwalten: Upgrade, Sync, Feedback, projektspezifische Agenten anl...",
        "tier": "optional",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      {
        "agent": "agent-meta-scout",
        "short_desc": "Claude-Ökosystem scouten: neue Skills, Rollen, Rules und Patterns entdecken",
        "tier": "optional",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      {
        "agent": "app-lifecycle-governor",
        "short_desc": "App-Lifecycle-Governance: Ownership, SLA, Data-Classification, Deprecation",
        "tier": "optional",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      {
        "agent": "bug-feature-analyzer",
        "short_desc": "Issue-Triage: Eingehende Bug-Meldungen und Feature-Requests analysieren und k...",
        "tier": "recommended",
        "orchestrator_only": true,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      {
        "agent": "claude-expert",
        "short_desc": "Absoluter Analyse-Experte für die Plattform Claude Code: Funktionsweise, Konf...",
        "tier": "optional",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      {
        "agent": "concept-architect",
        "short_desc": "Systemdesign für komplexe Änderungen: Komponenten, Schnittstellen, Trade-offs",
        "tier": "optional",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      {
        "agent": "concept-reviewer",
        "short_desc": "Konzept-Critic: reviewt Design-Docs und Konzepte auf Vollständigkeit, Logik, ...",
        "tier": "optional",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      {
        "agent": "concept-specifier",
        "short_desc": "Technische Spezifikationen aus Anforderungen und Codebase-Kontext — implementiert nicht",
        "tier": "optional",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      {
        "agent": "continue-expert",
        "short_desc": "Absoluter Analyse-Experte für die Plattform Continue: Funktionsweise, Konfigu...",
        "tier": "optional",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      {
        "agent": "copilot-expert",
        "short_desc": "Absoluter Analyse-Experte für die Plattform GitHub Copilot: Funktionsweise, K...",
        "tier": "optional",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      {
        "agent": "data-engineer",
        "short_desc": "ETL/ELT-Pipelines, Schema-Migration (Datenebene), Data-Quality-Checks, Lineag...",
        "tier": "optional",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      {
        "agent": "dependency-auditor",
        "short_desc": "Supply-Chain-Hygiene: SBOM-Analyse, Lizenz-Kompatibilität, Version-Drift und ...",
        "tier": "optional",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      {
        "agent": "docker",
        "short_desc": "Dev-Stack verwalten, Test-Stack starten, Binary-Management, Dockerfiles erste...",
        "tier": "optional",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      {
        "agent": "effort-estimator",
        "short_desc": "Schätzt Aufwände für Entwicklungsaufgaben basierend auf Task-Typ und LLM-Kali...",
        "tier": "optional",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      {
        "agent": "explorer",
        "short_desc": "Read-only Codebase-Recherche, Dependency- und Impact-Mapping, Datei- und Symb...",
        "tier": "optional",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      {
        "agent": "export-manager",
        "short_desc": "Target-agnostischer Output-Router: Markdown, Confluence, Jira-Xray, Notion.",
        "tier": "optional",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      {
        "agent": "feedback",
        "short_desc": "Projekt-Feedback standardisieren: Bugs, Features, Verbesserungen als GitHub I...",
        "tier": "required",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      {
        "agent": "gemini-expert",
        "short_desc": "Absoluter Analyse-Experte für die Plattform Gemini (Antigravity): Funktionswe...",
        "tier": "optional",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      {
        "agent": "intern-developer",
        "short_desc": "[EASTER EGG / GAG] Der übereifrige Praktikant",
        "tier": "optional",
        "orchestrator_only": false,
        "addressability": "name_only",
        "name_only_reason": "Easter-egg gag role with no real routing surface; reachable only via explicit name dispatch."
      },
      {
        "agent": "junior-developer",
      ...
      {
        "agent": "knowledge-gardener",
        "short_desc": "Kleinteilige Wiki-Pflege: Links reparieren, Tags harmonisieren, Frontmatter e...",
        "tier": "optional",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      {
        "agent": "knowledge-indexer",
        "short_desc": "Pflegt index.md (Content-Katalog, OKF §6) und log.md (Chronologisches Event-L...",
        "tier": "optional",
        "orchestrator_only": true,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      {
        "agent": "knowledge-ingestor",
        "short_desc": "Sources einlesen, Key Information extrahieren, Wiki-Seiten erstellen/ aktuali...",
        "tier": "optional",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      {
        "agent": "knowledge-linter",
        "short_desc": "Wiki-Gesundheitscheck: Widersprüche, Orphans, veraltete Claims, kaputte Links...",
        "tier": "optional",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      {
        "agent": "knowledge-migrator",
        "short_desc": "Vorhandene Projektinhalte aufräumen und OKF-konform ins Knowledge Wiki migrieren",
        "tier": "optional",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      {
        "agent": "log-analyzer",
        "short_desc": "System- und Applikations-Logs analysieren: Frequency-Clustering, Severity-Kla...",
        "tier": "required",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      {
        "agent": "mammouth-expert",
        "short_desc": "Absoluter Analyse-Experte für die Plattform Mammouth Code: Funktionsweise, Ko...",
        "tier": "optional",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      {
        "agent": "opencode-expert",
        "short_desc": "Absoluter Analyse-Experte für die Plattform Opencode: Funktionsweise, Konfigu...",
        "tier": "optional",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      },
      {
        ...
        "orchestrator_only": true,
        "addressability": "name_only",
        "name_only_reason": "Last-resort escalation tier; reached only via explicit name dispatch from the orchestrator, never via keyword routing."
      },
      {
        "agent": "product-manager",
        "short_desc": "Strategisches Produkt-Management: Backlog, User-Stories, Sprint-Planung, Prio...",
        "tier": "optional",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      {
        "agent": "refactoring-specialist",
        "short_desc": "Systematische großflächige Code-Transformation mit Sicherheitsnetz: Strangler...",
        "tier": "optional",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
      ...
      {
        "agent": "test-executor",
        "short_desc": "Bestehende Test-Suiten ausführen — kein Test-Design, kein Code-Schreiben",
        "tier": "optional",
        "orchestrator_only": false,
        "addressability": "keyword",
        "name_only_reason": ""
